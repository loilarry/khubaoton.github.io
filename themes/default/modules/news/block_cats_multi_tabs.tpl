<!-- BEGIN: main -->
<style type="text/css">
.tab-content {position: relative; margin-bottom: 10px;width: 100%;display: inline-block;background-color:#2C95E2;}
.tms-tabs {/*overflow-x: auto;*/white-space: nowrap;width: 100%; margin: 0 auto 10px; padding: 10px 0 10px; text-align: center;background-color:#2C95E2;}
.tms-tabs li {margin-right: 5px;margin-left: 5px;float: none;margin-bottom: -1px;display: inline-block}
.tms-tabs > li a {border: none;font-weight: normal;color: white; border-radius: 4px;padding: 8px 12px;margin-bottom: 5px;font-size: 16px;}
.tms-tabs > li a span {white-space: nowrap}
.tms-tabs > li.active a {background: #d71a1a !important;color: #fff}
...
.tmshome3_list_tin ul li a {font-size: 16px;color:white;font-weight:bold;}
...
<!-- BEGIN: cat_content -->
	...
	<ul>
		...
		<li>
			...
			<!-- END: img -->
			<div class="tmshome3_list_tin_text" style="color:white;">
			<a href="{ROW.link}" title="{ROW.title}" style="font-weight:bold !important;">{ROW.title}</a> <br/>
			{ROW.hometext_clean}
			</div>
		</li>
		<!-- END: loop -->
...
.tms_news_block_item_text h3 a {color: #303030;}
