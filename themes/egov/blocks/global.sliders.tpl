...
<div class="slider fix-slider-body">
	<div class="slider_botton">
		<div class="">
			<div id="jssor_2" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1900px; height: 395px; visibility: hidden; background: #fff;">
				...
				<div data-u="slides" class="sliders" style="cursor: default; position: relative; top: 0px; left: 0px; width: 1900px; height: 395px; overflow: hidden;text-align: center">
					<!-- BEGIN: loop -->
