...
<!-- END: loopcat1 -->
<marquee id="marq" scrollamount="3" direction="up" loop="50" scrolldelay="0" behavior="scroll" onmouseover="this.stop()" onmouseout="this.start()" style="height: 390px;">
<!-- BEGIN: loopcat0 -->
<div>
    <!-- <h2>{CATINFO.title}</h2> -->
    <ul class="clearfix">
    	...
    	<li class="clearfix">
    		<!-- BEGIN: img -->
    		<!-- <a href="{ROW.link}" title="{ROW.title}" {ROW.target_blank} ></a> -->
    		<!-- END: img -->
    		<h3><a {TITLE} class="show" href="{ROW.link}" {ROW.target_blank} data-content="{ROW.hometext_clean}" data-img="{ROW.thumb}" data-rel="cattitlebox">{ROW.title_clean}</a></h3>
