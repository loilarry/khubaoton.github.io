...
<div class="slider fix-slider-body" style="margin-bottom: 2%;">
	<div class="slider_botton">
		<div class="">
			<div id="jssor_2" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 768px; height: 123px; visibility: hidden; background: #fff;">
				...
				<div data-u="slides" class="sliders" style="cursor: default; position: relative; top: 0px; left: 0px; width: 768px; height: 123px; overflow: hidden;text-align: center">
					<!-- BEGIN: loop -->
