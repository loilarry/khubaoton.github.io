...
if (!nv_function_exists('nv_block_tmshome2')) {
    /**
     * nv_block_config_tmshome2()
     *
     * @param string $module
     ...
     * @return string
     */
    function nv_block_config_tmshome2($module, $data_block, $lang_block)
    {
        ...
        $html .= '<label class="control-label col-sm-6">' . $lang_block['blockidleft'] . ':</label>';
        ...
        $html .= '</div></div>';
		$html .= '<div class="form-group">';
        $html .= '<label class="control-label col-sm-6">' . $lang_block['numrowleft'] . ':</label>';
        $html .= '<div class="col-sm-9"><input type="text" class="form-control" name="config_numrowleft" size="5" value="' . $data_block['numrowleft'] . '"/></div>';
        $html .= '</div>';
		$html .= '<div class="form-group">';
        $html .= '<label class="control-label col-sm-6">' . $lang_block['blockidright'] . ':</label>';
        ...
        $html .= '</div></div>';
		$html .= '<div class="form-group">';
        $html .= '<label class="control-label col-sm-6">' . $lang_block['numrowright'] . ':</label>';
    ...
    /**
     * nv_block_config_tmshome2_submit()
     *
     * @param string $module
     * @param array  $lang_block
     * @return array
     */
    function nv_block_config_tmshome2_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
     ...
     * @return string|void
     */
    function nv_block_tmshome2($block_config)
    {
        ...
        if (!empty($listleft)) {
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . 'modules/' . $mod_file . '/block_tmshome2.tpl')) {
                $block_theme = $global_config['module_theme'];
            } else {
                $block_theme = 'default';
            }
            $xtpl = new XTemplate('block_tmshome2.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/' . $mod_file);
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_tmshome2($block_config);
    }
}
