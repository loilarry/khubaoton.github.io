...
if (!nv_function_exists('nv_block_tmshome5')) {
    /**
     * nv_block_config_tmshome5()
     *
     * @param string $module
     ...
     * @return string
     */
    function nv_block_config_tmshome5($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_tmshome5_submit()
     *
     * @param string $module
     * @param array  $lang_block
     * @return array
     */
    function nv_block_config_tmshome5_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = [];
        $return['error'] = [];
     ...
     * @return string|void
     */
    function nv_block_tmshome5($block_config)
    {
...
if (defined('NV_SYSTEM')) {
    ...
    if (isset($site_mods[$module])) {
        ...
        $content = nv_block_tmshome5($block_config);
    }
}
