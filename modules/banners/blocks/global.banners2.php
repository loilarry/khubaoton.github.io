...
if (!nv_function_exists('nv_block_data_config_banners2')) {
    /**
     ...
     * @return
     */
    function nv_block_data_config_banners2($module, $data_block, $lang_block)
    {
     ...
     * @return
     */
    function nv_block_data_config_banners_submit2($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
     ...
     * @return
     */
    function nv_block_global_banners2($block_config)
    {
        ...
        if (!empty($array_banners_content)) {
            ...
            if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/modules/banners/global.banners2.tpl')) {
                $block_theme = $global_config['module_theme'];
            } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/modules/banners/global.banners2.tpl')) {
                $block_theme = $global_config['site_theme'];
            } else {
                $block_theme = 'default';
            }

            $xtpl = new XTemplate('global.banners2.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/modules/banners');
...
if (defined('NV_SYSTEM')) {
    $content = nv_block_global_banners2($block_config);
}
